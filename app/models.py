...
class Reservation(db.Model):
    ...
    def to_dict(self):
        ...
        return {
            ...
            'booked_by': self.booked_by.name if self.booked_by else None,
            'booked_by_has_profile_picture': self.booked_by.has_profile_picture if self.booked_by else False,
            'booked_by_profile_picture_version': self.booked_by.profile_picture_version if self.booked_by else 0,
            'status': self.status,
